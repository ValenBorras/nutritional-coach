        ...
        <div className="flex flex-col lg:flex-row gap-12 items-center">
          <div className="flex-1">
            <h2 className="text-3xl md:text-4xl font-marcellus text-charcoal mb-6">
              Para <span className="text-sage-green">Nutricionistas</span>:
              Extiende Tu Cuidado Más Allá de las Citas
            </h2>
            <p className="text-lg text-charcoal/70 mb-8">
              NutriGuide te ayuda a brindar soporte continuo a tus clientes
              mientras mantienes tu enfoque y filosofía únicos. Configura la IA
              para alinearse con tus recomendaciones y monitorea el progreso de
              tus clientes.
            </p>
            ...
            <div className="space-y-6 mb-8">
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-charcoal/70">
                    Personaliza la IA para reflejar tu filosofía dietética y
                    enfoques preferidos.
                  </p>
                </div>
              </div>
              ...
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-charcoal/70">
                    Incorpora a tus clientes de manera fluida para recibir
                    orientación de IA alineada con tu cuidado.
                  </p>
                </div>
              </div>
              ...
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-charcoal/70">
                    Rastrea el compromiso y los resultados de tus clientes para
                    optimizar tus sesiones presenciales.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="flex-1 relative">
            <div className="bg-mist-white rounded-2xl p-6 border border-sage-green/20 shadow-sm max-w-md mx-auto">
              <div className="mb-6">
                <h3 className="font-marcellus text-xl text-charcoal mb-2">
                  Panel de Nutricionista
                </h3>
                <p className="text-sm text-charcoal/70">
                  Configura tu asistente de IA y monitorea el progreso de tus
                  clientes
                </p>
              </div>
                ...
                <div className="bg-warm-sand p-4 rounded-lg">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {[
                      ...
                      <span
                        key={i}
                        className="bg-soft-rose/20 text-charcoal px-3 py-1 rounded-full text-sm"
                      >
                        {tag}
                      </span>
                    ))}
              ...
              <Button
                variant="outline"
                className="w-full border-sage-green text-sage-green hover:bg-sage-green/10"
              >
                Ver Panel Completo
              </Button>
            </div>
