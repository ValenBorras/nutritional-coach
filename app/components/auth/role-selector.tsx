...
export function RoleSelector({ onSelect }: RoleSelectorProps) {
  return (
    <div className="grid md:grid-cols-2 gap-6 max-w-4xl mx-auto">
      <Card className="cursor-pointer hover:border-coral transition-colors" onClick={() => onSelect('patient')}>
        <CardHeader>
      ...
      <Card className="cursor-pointer hover:border-coral transition-colors" onClick={() => onSelect('nutritionist')}>
        <CardHeader>
          <CardTitle className="flex items-center gap-2 font-marcellus">
