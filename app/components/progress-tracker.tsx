...
export default function ProgressTracker() {
  ...
  const goals = [
    { name: "Protein Intake", current: 75, target: 100, unit: "g", color: "bg-coral" },
    { name: "Vegetable Servings", current: 4, target: 5, unit: "servings", color: "bg-sage-green" },
    { name: "Steps", current: 7500, target: 10000, unit: "steps", color: "bg-soft-rose" },
  ]
  ...
  return (
    <Card className="bg-warm-sand border-soft-rose/20">
      <CardHeader className="flex flex-row items-center justify-between pb-2">
        ...
        <Button variant="ghost" className="text-sage-green hover:bg-sage-green/10 h-8 px-2">
          View Details
      ...
      <CardContent>
        <div className="mb-6">
          <h3 className="text-sm font-medium text-charcoal mb-3">Weekly Consistency</h3>
        ...
        <div>
          <h3 className="text-sm font-medium text-charcoal mb-3">Today's Goals</h3>
