        ...
        {!selectedRole ? (
              ...
              <div className="grid md:grid-cols-2 gap-6">
                ...
                >
                  <CardContent className="p-6 text-center">
                    ...
                    <p className="text-charcoal/70 font-marcellus text-sm">
                      Quiero mejorar mi alimentación y recibir orientación
                ...
                >
                  <CardContent className="p-6 text-center">
                    ...
                    <p className="text-charcoal/70 font-marcellus text-sm">
                      Soy profesional de la nutrición y quiero ayudar a mis
                      pacientes
                    </p>
                  </CardContent>
                </Card>
          ...
          <div className="w-full max-w-4xl mx-auto">
            ...
            {selectedRole === "patient" ? (
              <PatientForm mode="oauth-onboarding" authUser={authUser} />
            ) : (
              <NutritionistForm mode="oauth-onboarding" authUser={authUser} />
            )}
          </div>
        )}
      </FadeIn>
